          ...
          <div key={category} className="mb-8">
            ...
            <div className="mb-6">
              <button
                ...
                className="w-full md:bg-gradient-to-r md:from-blue-600 md:via-blue-500 md:to-indigo-600 md:py-2 md:px-4 md:rounded-xl md:shadow-lg md:relative md:overflow-hidden group hover:md:shadow-xl transition-all text-left cursor-pointer hover:md:scale-[1.02]"
              >
                {/* Effet de brillance */}
